...
train<-read.csv("ccs.new_train_v1.csv", stringsAsFactors = FALSE)%>%select(-id)
trainCat<-train%>%select(type_cat, image_name)
test<-read.csv("ccs.new_test_v1.csv" , stringsAsFactors = FALSE)%>%select(-id)
